package com.hucong.huaicodemake.controller;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.hucong.huaicodemake.ai.AiCodeGenTypeRoutingService;
...
import com.hucong.huaicodemake.common.ResultUtils;
...
public class AppController {
    ...
    public BaseResponse<AppVO> getAppVOById(long id) {
        ThrowUtils.throwIf(id <= 0, ErrorCode.PARAMS_ERROR, "id 不能小于 0");
        // 查询数据库
    ...
    @Cacheable(
            value = "good_app_page",
            key ="T(com.hucong.huaicodemake.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
